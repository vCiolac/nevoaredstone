...
export default function QuizPage() {
  ...
  if (view === "result") {
    ...
    const instrumento = instrumentos[resultado];

    return (
      <main className="min-h-screen flex items-center justify-center px-6 py-12">
        <motion.div className="bg-black/80 p-8 rounded-2xl text-white text-center">
          <Image src={instrumento.imagem} alt={instrumento.nome} width={192} height={288} className="mx-auto mb-6" />
          <h2 className="text-4xl font-bold mb-3">{instrumento.nome}</h2>
          <p className="text-lg mb-6">{instrumento.descricao}</p>
